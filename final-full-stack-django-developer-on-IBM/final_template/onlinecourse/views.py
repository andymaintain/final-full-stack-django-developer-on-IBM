...
# <HINT> Create an exam result view to check if learner passed
#  exam and show their question results and result for each question,
...
def show_exam_result(request, course_id, submission_id):
    ...
    result = int(score/total_score) * 100
    context = {}
